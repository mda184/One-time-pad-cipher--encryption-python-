...
##############################################################
##		CS 2500( Fall 2016), Assignment #1, Question #2 	##
##			Script File Name	: decrypt.py                ##
...
"""Calculates the encrypted code for a file that needs to be
    ...
    Args:
        file: file containing data to be decrypted
        pad: One time PAD Cipher used to encrypt to decrypt
        pos: The position in the pad used to start encrypting from
        fout: file containing decrypted data

    Returns:
        a file with an decrypted code
...
file = open(sys.argv[1]) #data to be decrypted
